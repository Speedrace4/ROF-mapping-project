...
var lyr_Communities_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Communities_1, 
                style: style_Communities_2,
                popuplayertitle: "Communities",
                interactive: true,
                title: '<img src="styles/legend/Communities_1.png" /> Communities'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_OpenStreetMap_0_2.setVisible(true);lyr_Communities_1.setVisible(true);lyr_Communities_2.setVisible(true);
// lyr_Police_2.setVisible(false);
var layersList = [lyr_OpenStreetMap_0,lyr_Communities_1/*,lyr_Police_2*/];
var layersList2 = [lyr_OpenStreetMap_0_2,lyr_Communities_2];
...
lyr_Communities_2.set('fieldAliases', {'community': 'community', 'area': 'area', 'shape_area': 'shape_area', 'perimeter': 'perimeter', 'area_num_1': 'area_num_1', 'area_numbe': 'area_numbe', 'comarea_id': 'comarea_id', 'comarea': 'comarea', 'shape_len': 'shape_len', });
...
lyr_Communities_2.set('fieldImages', {'community': 'TextEdit', 'area': 'TextEdit', 'shape_area': 'TextEdit', 'perimeter': 'TextEdit', 'area_num_1': 'TextEdit', 'area_numbe': 'TextEdit', 'comarea_id': 'TextEdit', 'comarea': 'TextEdit', 'shape_len': 'TextEdit', });
...
lyr_Communities_2.set('fieldLabels', {'community': 'no label', 'area': 'no label', 'shape_area': 'no label', 'perimeter': 'no label', 'area_num_1': 'no label', 'area_numbe': 'no label', 'comarea_id': 'no label', 'comarea': 'no label', 'shape_len': 'no label', });
